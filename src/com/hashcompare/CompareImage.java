...
public class CompareImage {
	...
	public static void main(String[] args) {
		...
		String fileName = "./resources/img/";

		for(int i = 1;i<8;i++){
		    hashCode = getImageHashCode(fileName+"example" +i+".jpg");
		    hashCodes.add(hashCode);
		}
		System.out.println(hashCodes);
		String sourceHashCode = getImageHashCode(fileName + "source.jpg");
	...
	private static String getImageHashCode(String fileName){
